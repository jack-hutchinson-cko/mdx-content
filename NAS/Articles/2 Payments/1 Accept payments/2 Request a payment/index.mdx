...
- [using a token](/payments/accept-payments/request-a-payment#Using_a_token)
- [using a network token](/payments/accept-payments/request-a-payment#Using_a_network_token)
- [using full card details ](/payments/accept-payments/request-a-payment#Using_full_card_details)(requires SAQ D PCI compliance)
...
If you are [SAQ D PCI compliant](/payments/regulation-support/pci-compliance), you can use our Full Card API to request a payment using the full card details.
