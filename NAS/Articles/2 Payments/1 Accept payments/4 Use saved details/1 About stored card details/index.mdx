...
<TipBox variant="success" title="Easily transfer recurring payments to Checkout.com">
...
See the sections on  [cardholder-initiated transactions](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-cits) and  [merchant-initiated transactions](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-mits) further down for more detail.
...
- For both [scheduled](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-scheduled) and [unscheduled](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-unscheduled) MITs, you must include the `merchant_initiated: true` flag to mark the payment as merchant-initiated, and reference either the [original cardholder-initiated payment or the previous payment](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-previouspaymentid) in the series of transactions using the `previous_payment_id` attribute.
...
Merchant-initiated transactions (MITs) are payments you trigger, where the cardholder has previously consented to you carrying out such payments. These may be [scheduled](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-scheduled) (such as recurring payments and installments) or [unscheduled](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-unscheduled) (like account top-ups triggered by balance thresholds and no-show charges).
...
<Table>
<TableHead headers={['Pament sourse', 'First cardholder-initiated payment attributes', 'Second payment attributes']} />
<TableBody>
<TableRow>
<TableCell>
...
<Table>
<TableHead headers={['Pament sourse', 'First payment attributes', 'Second payment attributes']} />
<TableBody>
<TableRow>
<TableCell>
...
<Table>
<TableHead headers={['Pament sourse', 'First: Payment attributes required', 'Second: Payment attributes required']} />
<TableBody>
<TableRow>
<TableCell>
...
Card schemes handle scheduled (recurring) and unscheduled (not recurring) payments differently, so it's important that you include the proper identifiers in your payment requests to distinguish between these two types of merchant-initiated transactions (MITs). See above for the attributes required for [scheduled](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-scheduled) and [unscheduled](/payments/accept-payments/use-saved-details/about-stored-card-details#Aboutstoredcarddetails-unscheduled) MITs.
