...
Any organization involved with the processing, transmission, or storage of card data must comply with the <ExternalLink href="https://www.pcisecuritystandards.org/pci_security/" >Payment Card Industry Data Security Standards</ExternalLink> PCI DSS.
...
- Use our [Frames](/integrate/frames) integration method, which allows you to accept payments without ever handling card data.
