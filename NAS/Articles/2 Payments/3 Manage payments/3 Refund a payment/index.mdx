...
If a refund authorization is requested, you can find the Retrieval Reference Number (RRN) in [refund webhook notifications](/workflows) and in the [get payment actions](/payments/manage-payments/get-payment-actions) call.
...
If you want to know the reason for the decline, you can either [subscribe to refund webhook notifications](/workflows), use our [get payment actions endpoint](/payments/manage-payments/get-payment-actions), or view it in your Dashboard account.
