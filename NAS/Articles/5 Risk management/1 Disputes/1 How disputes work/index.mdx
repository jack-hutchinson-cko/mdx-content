...
<img src="/NAS/Risk management/Disputes+flow.png" maxWidth={700}  />
...
<Table>
<TableHead headers={['Event', 'API status', 'Webhook', 'Changeback code']} />
<TableBody>
<TableRow>
<TableCell>
...
[`dispute_evidence_required`](/workflows/webhook-event-types/dispute_evidence_required)
...
To challenge a dispute, submit all the relevant evidence to us and we will send it on to the issuer. Each scheme has a different [timeframe](#Defense_timeframes) in which you need to respond, but it's best to respond as soon as possible.
...
You can submit evidence through the [Dashboard](/dashboard/manage-disputes), or with our [API](/risk-management/disputes/disputes-api).

<TipBox variant="info">

You have a maximum of 20 days from receiving the dispute to submit your evidence, but this varies by scheme, and if you use a third-party acquirer. See the [timeframes](#Defense_timeframes) for more information.
...
[`dispute_accepted`](/workflows/webhook-event-types/dispute_accepted)
...
[`dispute_expired`](/workflows/webhook-event-types/dispute_expired)
...
- **Dispute lost**. If the issuer is not satisfied with your evidence, you lose the dispute. You can take your case to [arbitration](#Arbitration) if you want to argue your case further.
...
- You can submit additional evidence at this stage (unless it is a Visa [fraud](/resources/codes/chargeback-codes#Fraud) or [authorization](/resources/codes/chargeback-codes#Authorization) dispute). Your evidence should show why the dispute is now resolved, or why the issuer’s argument for rejecting your case is invalid.
...
<Table>
<TableHead headers={['Event', 'Status', 'Webhook', 'Chargeback code']} />
<TableBody>
<TableRow>
<TableCell>
...
[`dispute_arbitration_lost`](/workflows/webhook-event-types/dispute_arbitration_lost)
...
<sup>4</sup> You have five days to contact our Disputes Team at disputes@checkout.com if want to take your case to arbitration.
...
<Card title="Manage disputes from the Dashboard" href="/dashboard/manage-disputes">

Learn how to handle disputes from your Dashboard.

</Card>
<Card title="Manage disputes with our API" href="/risk-management/disputes/disputes-api">
