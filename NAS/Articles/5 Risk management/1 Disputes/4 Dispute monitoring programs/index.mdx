...
Learn about [Visa’s](#Visa's_dispute_monitoring_program) and [Mastercard’s](#Mastercard's_dispute_monitoring_program) dispute monitoring programmes below.

<TipBox variant="info">

If you need help or have any questions about the dispute monitoring programmes, contact our Risk team at risk@checkout.com.
...
- Your business has a high-risk [merchant category code](/resources/codes/merchant-category-codes) (MCC), and you have at least 100 disputes and a 0.90% dispute-to-sales ratio in the previous calendar month, **or**
...
<Table withTopBorder={false}>
<TableHead headers={['Number of chargebacks', 'Chargeback rate (basic points)']} />
<TableBody>
<TableRow>
<TableCell>
...
<Table>
<TableHead headers={['Number of months above ECM thresholds', 'Fines', 'Issuer recovery assessment']} />
<TableBody>
<TableRow>
<TableCell>
...
If you need support or have questions about the dispute monitoring programs, please contact our Risk team at risk@checkout.com.
