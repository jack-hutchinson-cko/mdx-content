...
You can manage and respond to disputes in two ways: through the [Dashboard](/dashboard/disputes), or our [API](/risk-management/disputes/disputes-api).
...
If you’ve already refunded the customer, we will automatically defend the dispute on your behalf to prevent a double refund, helping you to focus on other cases. See below for [partial refunds](#Disputes_on_partially_refunded_payments).
...
You can upload and submit evidence through the [Dashboard](/dashboard/manage-disputes) or with our [API](/risk-management/disputes/disputes-api).
...
<Card title="Dispute reasons and recommended evidence" href="/risk-management/disputes/responding-to-disputes/dispute-reasons-and-recommended-evidence">
