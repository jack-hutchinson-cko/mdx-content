...
You can view a request example with all of these fields on our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#operation/createAPaymentLinkSession" >API reference</ExternalLink>.
...
For a full explanation of the fields, see our <ExternalLink href="https://api-reference.checkout.com/preview/crusoe/#tag/Payment-Links" >API reference</ExternalLink>.
