...
Payment Links now supports six more payment methods.
...
2. Checkout.com generates a unique link you can share with your customer.
...
5. After the payment's been processed, you'll be notified by a [webhook](/reporting-and-insights/webhooks).
...
<ContentPanel variant="heading" title="Manage Payment Links" imgSrc="/docs/Collect payment/Payment.svg" withBorder={false}>
